...
public abstract interface UBOreTexturizer
{
    ...
    public abstract void setupUBOre(Block paramBlock, String paramString, FMLPreInitializationEvent paramFMLPreInitializationEvent);

    @Deprecated
    public abstract void setupUBOre(Block paramBlock, int paramInt, String paramString, FMLPreInitializationEvent paramFMLPreInitializationEvent);

    public abstract void setupUBOre(Block paramBlock, int paramInt, String paramString1, String paramString2, FMLPreInitializationEvent paramFMLPreInitializationEvent);
