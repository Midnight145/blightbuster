...
public interface IWailaBlock {
     ...
     * You get the world, the player and the location of the block. With that, it is easy to gather information & tile
     * entities
     */
     ...
     * You get in input world, player and the block location. You also get the itemstack as returned by the default
     * lookup system or getWailaStack().
     * ConfigHandler provides the current Waila config state so you can show/hide elements depending on the
     * configuration. Refer the ConfigHandler class for more info.
