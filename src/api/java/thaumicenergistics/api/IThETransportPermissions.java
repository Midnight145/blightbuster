...
public interface IThETransportPermissions {
     ...
     */
    public <T extends TileEntity & IAspectContainer> boolean addAspectContainerTileToBothPermissions(Class<T> tileClass,
        int capacity);
    ...
    public <T extends TileEntity & IAspectContainer> boolean addAspectContainerTileToExtractPermissions(
        Class<T> tileClass, int capacity);
     ...
     */
    public void addEssentiaContainerItemToTransportPermissions(Class<? extends IEssentiaContainerItem> itemClass,
     ...
     * @param canHoldPartialAmount
     */
    public void addEssentiaContainerItemToTransportPermissions(ItemStack containerItem, int capacity,
