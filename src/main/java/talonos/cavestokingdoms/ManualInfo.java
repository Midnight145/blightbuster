...
public class ManualInfo {
	...
	public ManualInfo() {
		...
		this.initManual(this.mats0, "basicManual.0", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.mats1Doc;
		this.initManual(this.mats1, "basicManual.1", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.mats2Doc;
		this.initManual(this.mats2, "basicManual.2", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.mats3Doc;
		this.initManual(this.mats3, "basicManual.3", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.mats4Doc;
		this.initManual(this.mats4, "basicManual.4", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.mats5doc;
		this.initManual(this.mats5, "basicManual.5", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.ben1doc;
		this.initManual(this.ben1, "basicManual.6", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.ben2doc;
		this.initManual(this.ben2, "basicManual.7", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.ben3doc;
		this.initManual(this.ben3, "basicManual.8", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.ben4doc;
		this.initManual(this.ben4, "basicManual.9", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.taint1Doc;
		this.initManual(this.taint1, "basicManual.10", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.taint2Doc;
		this.initManual(this.taint2, "basicManual.11", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.sarah1Doc;
		this.initManual(this.sarah1, "basicManual.12", "\u00a7o" + StatCollector.translateToLocal("manual1.tooltip"), d,
				"tinker:tinkerbook_diary");
		d = this.sarah2Doc;
