...
public class ItemManual extends ItemOreManual {
	...
	public ItemStack onItemRightClick(ItemStack stack, World world, EntityPlayer player) {
		...
		FMLClientHandler.instance().displayGuiScreen(player, new GuiManual(stack, this.getData(stack)));
		return stack;
	}
	...
	@Override
	@SideOnly(Side.CLIENT)
	public IIcon getIconFromDamage(int meta) { return this.icons[meta]; }
