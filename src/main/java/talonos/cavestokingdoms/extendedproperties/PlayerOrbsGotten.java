...
public class PlayerOrbsGotten implements IExtendedEntityProperties
{
	...
	public void saveNBTData(NBTTagCompound compound)
	{
		...
		between your tag names and vanilla tag names. For instance, if you add some "Items" 
		tag, that will conflict with vanilla. Not good. So just use a unique tag name.
		*/
	...
	/*
	That's it for the IExtendedEntityProperties methods, but we need to add a few of our own in order to 
