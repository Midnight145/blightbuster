...
public class UBCIntegration
{
    public static void init(FMLPreInitializationEvent e)
    {
    	...
    	try 
    	{
    		Logger.getAnonymousLogger().warning("Trying to UBify Thaumcraft Ores...");
            //UBAPIHook.ubAPIHook.ubOreTexturizer.requestUBOreSetup(ConfigBlocks.blockCustomOre, 0, "cavestokingdoms:misc/cinnibar", "ubc.cavestokingdoms.cinnabar");
            //UBAPIHook.ubAPIHook.ubOreTexturizer.requestUBOreSetup(ConfigBlocks.blockCustomOre, 1, "cavestokingdoms:misc/air", "ubc.cavestokingdoms.air");
            //UBAPIHook.ubAPIHook.ubOreTexturizer.requestUBOreSetup(ConfigBlocks.blockCustomOre, 2, "cavestokingdoms:misc/fire", "ubc.cavestokingdoms.fire");
            //UBAPIHook.ubAPIHook.ubOreTexturizer.requestUBOreSetup(ConfigBlocks.blockCustomOre, 3, "cavestokingdoms:misc/water", "ubc.cavestokingdoms.water");
            //UBAPIHook.ubAPIHook.ubOreTexturizer.requestUBOreSetup(ConfigBlocks.blockCustomOre, 4, "cavestokingdoms:misc/earth", "ubc.cavestokingdoms.earth");
            //UBAPIHook.ubAPIHook.ubOreTexturizer.requestUBOreSetup(ConfigBlocks.blockCustomOre, 5, "cavestokingdoms:misc/order", "ubc.cavestokingdoms.order");
            //UBAPIHook.ubAPIHook.ubOreTexturizer.requestUBOreSetup(ConfigBlocks.blockCustomOre, 6, "cavestokingdoms:misc/entropy", "ubc.cavestokingdoms.entropy");
