...
public class C2KBowMaterialsPage extends OreDiscoveryPage
{
    ...
    private void renderUnlocked(int localWidth, int localHeight, int i) {
        ...
        manual.renderitem.renderItemAndEffectIntoGUI(manual.fonts, manual.getMC().renderEngine, icons[i], localWidth + 150, localHeight + 4);
        ...
        if (materials[i] != null)
        {
            ...
            manual.fonts.drawString(xpRequired + ": " + (XPAdjustmentMap.get(materials[i].materialName) * 100f)+"% ", localWidth, localHeight + 50, 0);
            ...
            if (arrowsOn)
            {
                ...
                manual.fonts.drawString(breakChance + ": " + (arrowMaterials[i].breakChance * 15f)+"% ", localWidth + 85, localHeight + 30, 0);
            }
