...
public class BlockScannerGauge extends BSBlock implements ITileEntityProvider {
	...
	@Override
	public TileEntity createNewTileEntity(World p_149915_1_, int p_149915_2_) { return new TileEntityGauge(); }
	...
	public void breakBlock(World world, int x, int y, int z, Block block, int side) {
		if (world.getTileEntity(x, y, z) != null)
			((TileEntityGauge) world.getTileEntity(x, y, z)).unregister();
	}
