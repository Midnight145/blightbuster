...
public class GuiBadgePrinter extends GuiContainer {
    ...
    {
        this.fontRendererObj.drawString(this.printer.hasCustomInventoryName() ? this.printer.getInventoryName() : I18n.format(this.printer.getInventoryName(), new Object[0]), 8, 6, 4210752);
        this.fontRendererObj.drawString(this.player.hasCustomInventoryName() ? this.player.getInventoryName() : I18n.format(this.player.getInventoryName(), new Object[0]), 34, this.ySize - 96 + 2, 4210752);
    }
