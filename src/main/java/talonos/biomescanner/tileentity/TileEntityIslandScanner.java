...
public class TileEntityIslandScanner extends TileEntity implements ISidedInventory {
	...
	@Override
	public void onChunkUnload() { unregister(); }
	
	public void unregister() { MapScanner.instance.bus().unregister(this); }
	...
	@Override
	public ItemStack getStackInSlot(int slot) { return tempInventory[slot]; }
	
	@Override
	public void setInventorySlotContents(int slot, ItemStack stack) { tempInventory[slot] = stack; }
	
	@Override
	public ItemStack decrStackSize(int slot, int amount) { return getStackInSlot(slot); }
	...
	@Override
	public String getInventoryName() { return "gui.inventory.scanner"; }
	
	@Override
	public boolean hasCustomInventoryName() { return false; }
	
	@Override
	public boolean canInsertItem(int slot, ItemStack itemStack, int side) { return false; }
