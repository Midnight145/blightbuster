...
public class BasicMultiblockState implements IMultiblockEntryState {
	...
	public BasicMultiblockState(Block block) { this(block, 0, 0); }
	
	public BasicMultiblockState(Block block, int meta) { this(block, meta, 0xF); }
	
	public Block getBlock() { return this.block; }
	
	public int getMeta() { return this.meta; }
	
	public int getMetaFlags() { return this.metaFlags; }
	...
	protected int getReplacementMeta(int orientation) { return this.meta & this.metaFlags; }
