...
public class BlockTransportManager {
	...
	private static class BlockData {
		...
		public NBTTagCompound getTileEntityData() { return this.tileEntityData; }
	}
	...
	protected BlockData getBlockData(World world, int originX, int originY, int originZ, int offsetX, int offsetY,
		...
		return new BlockData(offsetX, offsetY, offsetZ, block,
				world.getBlockMetadata(originX + offsetX, originY + offsetY, originZ + offsetZ), tileEntityData);
	}
	...
	protected boolean shouldCaptureBlock(Block block) { return Arrays.asList(capturableBlocks).contains(block); }
