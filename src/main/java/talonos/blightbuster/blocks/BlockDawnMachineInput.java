...
public class BlockDawnMachineInput extends BlockMultiblock {
	...
	public IIcon getIcon(int side, int meta) {
		if (ForgeHooksClient.getWorldRenderPass() == 1) { return getInputIcon(transformSide(side, meta), meta); }
	...
	@Override
	public TileEntity createTileEntity(World world, int meta) { return new DawnMachineSpoutTileEntity(); }
