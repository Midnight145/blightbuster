...
public class AddedResearch {
	...
	public static void initResearch() {
		...
		final ShapedArcaneRecipe silverPotRecipe = ThaumcraftApi.addArcaneCraftingRecipe("SILVERPOTION",
				new ItemStack(BBItems.silverPotion, 6), new AspectList().add(Aspect.WATER, 15).add(Aspect.ORDER, 24),
				"FLF", 'L', new ItemStack(ConfigBlocks.blockMagicalLeaves, 1, 1), 'F',
				new ItemStack(Items.glass_bottle));

		final ShapedArcaneRecipe purityFocusRecipe = ThaumcraftApi.addArcaneCraftingRecipe("PURITYFOCUS",
				new ItemStack(BBItems.purityFocus), new AspectList().add(Aspect.WATER, 5).add(Aspect.ORDER, 8), "SQS",
				"QFQ", "SQS", 'S', new ItemStack(ConfigItems.itemShard, 1, 4), 'Q', new ItemStack(Items.quartz), 'F',
				new ItemStack(ConfigBlocks.blockCustomPlant, 1, 4));

		final InfusionRecipe dawnTotemRecipe = ThaumcraftApi.addInfusionCraftingRecipe("DAWNTOTEM",
		...
		final ResearchItem silverPotResearch = new ResearchItem("SILVERPOTION", // research name
		...
		silverPotResearch.setPages(new ResearchPage("tc.research_page.SILVERPOTION.1"),
		...
		final ResearchItem purityFocusResearch = new ResearchItem("PURITYFOCUS", "ALCHEMY",
		...
		purityFocusResearch.setPages(new ResearchPage("tc.research_page.PURITYFOCUS.1"),
		...
		final ResearchItem dawnTotemResearch = new ResearchItem("DAWNTOTEM", "ALCHEMY",
		...
		if (Loader.isModLoaded("ThermalExpansion")) {
			final ShapedArcaneRecipe dawnChargerRecipe = ThaumcraftApi.addArcaneCraftingRecipe("DAWNCHARGER",
					...
					"SSS", "SLS", "SSS", 'S', new ItemStack(ConfigBlocks.blockMagicalLog, 1, 1), 'L',
			...
			dawnChargerResearch.setPages(new ResearchPage("tc.research_page.DAWNCHARGER.1"),
		...
		// "DAWNCHARGER", "ALCHEMY", new AspectList().add(Aspect.ORDER,
		// 4).add(Aspect.VOID, 5)
		// .add(Aspect.MECHANISM, 8).add(Aspect.ENERGY, 4).add(Aspect.MAGIC, 8),
		// -4, -7, 2, new ItemStack(BBBlock.dawnCharger));
		//
		// dawnChargerResearch.setPages(new ResearchPage[] { new
		// ResearchPage("tc.research_page.DAWNCHARGER.1"),
		// new ResearchPage(dawnChargerRecipe) });
		//
		// dawnChargerResearch.setConcealed();
