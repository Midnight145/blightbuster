...
public class AddedResearch {
	...
	public static void initResearch() {
		...
		ShapedArcaneRecipe purityFocusRecipe = ThaumcraftApi.addArcaneCraftingRecipe("PURITYFOCUS", new ItemStack(BBItems.purityFocus),
				...
				new Object[] { "SQS", "QFQ", "SQS", 'S', new ItemStack(ConfigItems.itemShard, 1, 4), 'Q', new ItemStack(Items.quartz), 'F',
						new ItemStack(ConfigBlocks.blockCustomPlant, 1, 4) });

		InfusionRecipe dawnTotemRecipe = ThaumcraftApi.addInfusionCraftingRecipe(
				"DAWNTOTEM", new ItemStack(BBBlock.dawnTotem), 6, new AspectList().add(Aspect.AURA, 16).add(Aspect.HEAL, 32)
		...
		InfusionRecipe emberHeartRecipe = ThaumcraftApi.addInfusionCraftingRecipe("NETHERMIND", new ItemStack(ModItems.netherHeart), 6,
				...
				new ItemStack[] { // items in recipe
						...
						new ItemStack(Items.blaze_rod), new ItemStack(Blocks.netherrack), new ItemStack(Blocks.netherrack),
						new ItemStack(Blocks.obsidian), new ItemStack(Blocks.obsidian), new ItemStack(Items.leather) });

		ShapedArcaneRecipe dawnChargerRecipe = ThaumcraftApi.addArcaneCraftingRecipe("DAWNCHARGER", new ItemStack(BBBlock.dawnCharger),
				new AspectList().add(Aspect.WATER, 25).add(Aspect.ORDER, 25).add(Aspect.ENTROPY, 25).add(Aspect.FIRE, 25)
						.add(Aspect.EARTH, 25).add(Aspect.AIR, 25),
		...
		silverPotResearch.setPages(new ResearchPage[] { new ResearchPage("tc.research_page.SILVERPOTION.1"), // page in language file
		...
		ResearchItem purityFocusResearch = new ResearchItem("PURITYFOCUS", "ALCHEMY",
				new AspectList().add(Aspect.TOOL, 3).add(Aspect.HEAL, 6).add(Aspect.TAINT, 3).add(Aspect.MAGIC, 3), -3, -4, 2,
				new ItemStack(BBItems.purityFocus));

		purityFocusResearch
				.setPages(new ResearchPage[] { new ResearchPage("tc.research_page.PURITYFOCUS.1"), new ResearchPage(purityFocusRecipe) });
		...
		ResearchItem dawnTotemResearch = new ResearchItem("DAWNTOTEM", "ALCHEMY",
				new AspectList().add(Aspect.AURA, 6).add(Aspect.HEAL, 8).add(Aspect.TAINT, 3).add(Aspect.MAGIC, 6), -2, -6, 2,
				new ItemStack(BBBlock.dawnTotem));

		dawnTotemResearch
				.setPages(new ResearchPage[] { new ResearchPage("tc.research_page.DAWNTOTEM.1"), new ResearchPage(dawnTotemRecipe) });
		...
		ResearchItem dawnChargerResearch = new ResearchItem("DAWNCHARGER", "ALCHEMY", new AspectList().add(Aspect.ORDER, 4)
				.add(Aspect.VOID, 5).add(Aspect.MECHANISM, 8).add(Aspect.ENERGY, 4).add(Aspect.MAGIC, 8), -4, -7, 2,
				new ItemStack(BBBlock.dawnCharger));

		dawnChargerResearch
				.setPages(new ResearchPage[] { new ResearchPage("tc.research_page.DAWNCHARGER.1"), new ResearchPage(dawnChargerRecipe) });
