...
public class AddedResearch {
	...
	public static void initResearch() {
		...
		ShapedArcaneRecipe silverPotRecipe = ThaumcraftApi.addArcaneCraftingRecipe("SILVERPOTION",
				new ItemStack(BBItems.silverPotion, 6), new AspectList().add(Aspect.WATER, 15).add(Aspect.ORDER, 24), // aspects,
																														 // requires
																														 // 15
																														 // aqua
																														 // and
																														 // 24
																														 // ordo
				new Object[] { "FLF", // recipe pattern
						'L', new ItemStack(ConfigBlocks.blockMagicalLeaves, 1, 1), // Silverwood leaves
						'F', new ItemStack(Items.glass_bottle) // glass bottle
				});
				
		ShapedArcaneRecipe purityFocusRecipe = ThaumcraftApi.addArcaneCraftingRecipe("PURITYFOCUS",
				new ItemStack(BBItems.purityFocus), new AspectList().add(Aspect.WATER, 5).add(Aspect.ORDER, 8),
				new Object[] { "SQS", "QFQ", "SQS", 'S', new ItemStack(ConfigItems.itemShard, 1, 4), 'Q',
						new ItemStack(Items.quartz), 'F', new ItemStack(ConfigBlocks.blockCustomPlant, 1, 4) });
		
		InfusionRecipe dawnTotemRecipe = ThaumcraftApi.addInfusionCraftingRecipe("DAWNTOTEM",
				new ItemStack(BBBlock.dawnTotem), 6, new AspectList().add(Aspect.AURA, 16).add(Aspect.HEAL, 32)
						.add(Aspect.LIFE, 48).add(Aspect.LIGHT, 16).add(Aspect.ARMOR, 32).add(Aspect.ORDER, 48),
		...
		InfusionRecipe emberHeartRecipe = ThaumcraftApi.addInfusionCraftingRecipe("NETHERMIND",
				new ItemStack(ModItems.netherHeart), 6, new AspectList().add(DarkAspects.NETHER, 16)
						.add(Aspect.EXCHANGE, 16).add(Aspect.MAGIC, 32).add(DarkAspects.WRATH, 16),
				new ItemStack(Items.ghast_tear), // center item
				new ItemStack[] { // items in recipe
						new ItemStack(Items.blaze_rod), new ItemStack(Items.blaze_rod), new ItemStack(Items.blaze_rod),
						new ItemStack(Items.blaze_rod), new ItemStack(Blocks.netherrack),
						new ItemStack(Blocks.netherrack), new ItemStack(Blocks.obsidian),
						new ItemStack(Blocks.obsidian), new ItemStack(Items.leather) });
		
		ShapedArcaneRecipe dawnChargerRecipe = ThaumcraftApi.addArcaneCraftingRecipe("DAWNCHARGER",
				new ItemStack(BBBlock.dawnCharger),
				new AspectList().add(Aspect.WATER, 25).add(Aspect.ORDER, 25).add(Aspect.ENTROPY, 25)
						.add(Aspect.FIRE, 25).add(Aspect.EARTH, 25).add(Aspect.AIR, 25),
				new Object[] { "SSS", "SLS", "SSS", 'S', new ItemStack(ConfigBlocks.blockMagicalLog, 1, 1), 'L',
						new ItemStack(TEBlocks.blockFrame, 1, 7), });
		
		ResearchItem silverPotResearch = new ResearchItem("SILVERPOTION", // research name
				"ALCHEMY", // thaumonomicon page
				new AspectList().add(Aspect.WATER, 3).add(Aspect.HEAL, 6).add(Aspect.TAINT, 3).add(Aspect.PLANT, 3), // aspects
																													 // in
																													 // research
				-1, -4, 2, // location in thaumonomicon
				new ItemStack(BBItems.silverPotion)); // research icon
		
		silverPotResearch.setPages(new ResearchPage[] { new ResearchPage("tc.research_page.SILVERPOTION.1"), // page in
																											 // language
																											 // file
		...
		ResearchItem purityFocusResearch = new ResearchItem("PURITYFOCUS", "ALCHEMY",
				new AspectList().add(Aspect.TOOL, 3).add(Aspect.HEAL, 6).add(Aspect.TAINT, 3).add(Aspect.MAGIC, 3), -3,
				-4, 2, new ItemStack(BBItems.purityFocus));
		
		purityFocusResearch.setPages(new ResearchPage[] { new ResearchPage("tc.research_page.PURITYFOCUS.1"),
		...
		ResearchItem dawnTotemResearch = new ResearchItem("DAWNTOTEM", "ALCHEMY",
				new AspectList().add(Aspect.AURA, 6).add(Aspect.HEAL, 8).add(Aspect.TAINT, 3).add(Aspect.MAGIC, 6), -2,
				-6, 2, new ItemStack(BBBlock.dawnTotem));
		
		dawnTotemResearch.setPages(new ResearchPage[] { new ResearchPage("tc.research_page.DAWNTOTEM.1"),
		...
		ResearchItem dawnChargerResearch = new ResearchItem(
				"DAWNCHARGER", "ALCHEMY", new AspectList().add(Aspect.ORDER, 4).add(Aspect.VOID, 5)
						.add(Aspect.MECHANISM, 8).add(Aspect.ENERGY, 4).add(Aspect.MAGIC, 8),
				-4, -7, 2, new ItemStack(BBBlock.dawnCharger));
		
		dawnChargerResearch.setPages(new ResearchPage[] { new ResearchPage("tc.research_page.DAWNCHARGER.1"),
		...
		WandTriggerRegistry.registerWandBlockTrigger(wandTrigger, 0, ConfigBlocks.blockMagicalLog, 1,
				"cavestokingdoms");
