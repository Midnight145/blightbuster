...
public enum Mixins {
    ...
    DISABLE_TAINT_SPREAD(new Builder("Disables block-to-block taint spread").addTargetedMod(TargetedMod.THAUMCRAFT)
        .setSide(Side.BOTH)
        .setPhase(Phase.LATE)
        .addMixinClasses("MixinBlockTaintFibres")
        .setApplyIf(() -> true)),
    DISABLE_NODE_SPREAD(new Builder("Disables tainted node taint spread").addTargetedMod(TargetedMod.THAUMCRAFT)
        .setSide(Side.BOTH)
        .setPhase(Phase.LATE)
        .addMixinClasses("MixinTaintedSheepAI")
        .setApplyIf(() -> true)),
